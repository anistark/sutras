...
### Added
- Claude Code plugin support (`.claude-plugin/plugin.json` and `skills/sutras/SKILL.md`)
- Plugin marketplace install via AgentHub

## [v0.4.3](https://github.com/anistark/sutras/compare/v0.4.1...v0.4.3) - 2026-03-01
